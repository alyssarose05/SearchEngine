// DISCLAIMER: THIS CODE IS NOT MINE. MINOR EDITS WERE MADE TO FIT THE PROGRAM (MADE METHODS STATIC). THIS IS FROM CAARMEN'S PORTER-STEMMER REPOSITORY ON GITHUB. LINK TO ORIGINAL CODE: https://github.com/caarmen/porter-stemmer/blob/master/library/src/main/java/ca/rmen/porterstemmer/PorterStemmer.java
...
public class PorterStemmer {
    ...
    static private char getLetterType(char previousLetter, char letter) {
        switch (letter) {
            case 'a':
            case 'e':
            case 'i':
